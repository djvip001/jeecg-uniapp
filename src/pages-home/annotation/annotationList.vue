...
const goEmailDetailPage = (item) => {
  ...
  uni.navigateTo({
    url: '/pages-super/mail/mailDetail?id=' + item.busId + '&routerName=annotationList',
  })
}
// 去处理流程列表
...
const handleFilterChange = ([flag, category, _msgCategory, startTime, endTime]) => {
  starFlag.value = flag
  noticeType.value = category
  msgCategory.value = _msgCategory
