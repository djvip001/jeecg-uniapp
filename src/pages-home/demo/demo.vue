  ...
  <PageLayout backRouteName="index" navTitle="组件示例" routeMethod="pushTab">
    <scroll-view scroll-y>
      ...
      <view class="box router shadow-warp">
        <wd-button @click="handleSkip('/pages-home/demo/tree')">树组件</wd-button>
        <wd-button @click="handleSkip('/pages-home/demo/indexBar')">通讯录</wd-button>
        <wd-button @click="handleSkip('/pages-home/demo/selectPicker')">单选多选</wd-button>
        <wd-button @click="handleSkip('/pages-home/demo/form')">表单</wd-button>
      </view>
