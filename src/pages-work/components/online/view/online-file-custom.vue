  ...
  <view>
    <template v-if="fileList && fileList.length > 0">
      <view class="cu-list menu-avatar ol-file-list">
        ...
        >
          <view class="flex align-center" @tap="viewFile(item)">
            <text
    ...
    <LFile ref="customFile" @up-success="onSuccess" @up-error="onError" @webview-close="onWebviewClose"></LFile>
  </view>
</template>
...
// 预览文件
const viewFile = (item) => {
  downloadFile(getFileAccessHttpUrl(item.url))
}
